...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    ClosetRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const ClosetPage(),
      );
    },
...
/// generated route for
/// [ClosetPage]
class ClosetRoute extends PageRouteInfo<void> {
  const ClosetRoute({List<PageRouteInfo>? children})
      : super(
          ClosetRoute.name,
          initialChildren: children,
        );

  static const String name = 'ClosetRoute';
